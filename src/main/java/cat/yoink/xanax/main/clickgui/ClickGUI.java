...
public final class ClickGUI extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GuiUtil.drawRect(x + 10, y + 50, w - 20, h - 60, new Color(43, 43, 43).getRGB());
        GuiUtil.drawRect(x + 15, y + 70, w - 30, h - 85, new Color(34, 34, 34).getRGB());

        GuiUtil.drawSmoothRect(x + 15, y + 57, 10, 10, 3, new Color(34, 34, 34).getRGB());
        CFontRenderer.TEXT.drawString("<", x + 16, y + 57.5f, -1);

        GuiUtil.drawSmoothRect(x + 355, y + 57, 10, 10, 3, new Color(34, 34, 34).getRGB());
